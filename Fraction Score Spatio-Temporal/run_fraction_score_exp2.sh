mkdir "Results_EXP2"  # directory for storing all Results
mkdir "Stats_EXP2"   # directory for storing all Stats
mkdir "Trees_EXP2"    # directory for storing IR Trees
...
do
	...
	do
		...
		mkdir "Results_EXP2/Result $min_sup $dist_thresh"
		# Stat directory for a specific minimum support, distance threshold and number of slots
		mkdir "Stats_EXP2/Stat $min_sup $dist_thresh"
		# Tree directory for a specific minimum support, distance threshold and number of slots
		mkdir "Trees_EXP2/Tree_${min_sup}_${dist_thresh}"
		
		location_file="Data_EXP2/data_loc.csv"  # location of the object files
		keyword_file="Data_EXP2/data_type.csv"  # location of the keyword files
		...
		ir_tree_file="Trees_EXP2/Tree_${min_sup}_${dist_thresh}/data_tree.txt"
		...
		mv "result.txt" "Results_EXP2/Result $min_sup $dist_thresh/result.txt"
		# stats are stored in stat.txt, move it so that it is saved
		mv "stat.txt" "Stats_EXP2/Stat $min_sup $dist_thresh/stat.txt"
	done
done
...
do
	...
	do
		...
		do
			...
			# Result directory for a specific minimum support, distance threshold and number of slots
			mkdir "Results_EXP2/Result $tmin_sup $tdist_thresh $num_of_slot"
  			# Stat directory for a specific minimum support, distance threshold and number of slots
			mkdir "Stats_EXP2/Stat $tmin_sup $tdist_thresh $num_of_slot"
			# Tree directory for a specific minimum support, distance threshold and number of slots
			mkdir "Trees_EXP2/Tree_${tmin_sup}_${tdist_thresh}_$num_of_slot"
			
			location_file="Data_EXP2/data_loc_$num_of_slot.csv"  # location of the object files
			keyword_file="Data_EXP2/data_type_$num_of_slot.csv"  # location of the keyword files
			...
			# location of the IR tree file
			ir_tree_file="Trees_EXP2/Tree_${tmin_sup}_${tdist_thresh}_$num_of_slot/data_tree.txt"
			...
			# results are stored in result.txt, move it so that it is saved
			mv "result.txt" "Results_EXP2/Result $tmin_sup $tdist_thresh $num_of_slot/result.txt"
			# stats are stored in stat.txt, move it so that it is saved
			mv "stat.txt" "Stats_EXP2/Stat $tmin_sup $tdist_thresh $num_of_slot/stat.txt"
		done
	done
done
